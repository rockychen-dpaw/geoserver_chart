{{- define "geocluster.hazelcast.xml" }}<?xml version="1.0" encoding="UTF-8"?>
<!--
...
<hazelcast xmlns="http://www.hazelcast.com/schema/config"
    ...
    -->
    <cluster-name>{{ $.Release.Name }}-geocluster</cluster-name>
    ...
    <network>
        ...
        <join>
            ...
            <tcp-ip enabled="false">
                ...
                <member-list>
                    <member>geocluster-test-geoclusteradmin-748dc87d94-h9lvv</member>
                </member-list>
            </tcp-ip>
            <!--
            ...
            <kubernetes enabled="true">
                 <service-dns>{{$.Release.Name}}-geocluster-hazelcast-headless.{{$.Release.Namespace}}</service-dns>
            </kubernetes>
            <!--
